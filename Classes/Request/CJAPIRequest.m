...
- (void)setPath:(NSString *)path
{
    ...
    NSString *versionNum = [[CJEngine sharedEngine] apiVersion];
    NSString *version = [NSString stringWithFormat:@"/v%@/", versionNum];
...
{
    NSString *clientId = [[CJEngine sharedEngine] clientKey];
    NSString *accessToken = [[CJEngine sharedEngine] userToken];
