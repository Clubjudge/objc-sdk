...
#define COCOAPODS_VERSION_MINOR_CJKit_BAPersistentOperationQueue 2
...
#define COCOAPODS_VERSION_MINOR_CJKit_PromiseKit 2
...
#define COCOAPODS_VERSION_MINOR_CJKit_base 2
