#
#  Be sure to run `pod spec lint CJKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Bruno Abrantes"
  # s.authors            = { "Bruno Abrantes" => "inf0rmer.realm@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Bruno Abrantes"
  ...
  s.public_header_files = "CJAPIClient/CJAPIClient.h"
